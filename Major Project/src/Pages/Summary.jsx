      ...
      <div className={styles.heading}>
        <div className={styles.text}>
          ...
          <div className={styles.member}>
            {/*  */}
            <div>
              <h2 style={{ fontSize: "40px", width: "70%", margin: "2%" }}>
                Frequently added together
              </h2>
              <div className={styles.suggetions}>
                <div>
                  <img
                    src="https://media.istockphoto.com/id/1293613827/photo/happy-woman-shaking-hands-with-repairman-home-interior.jpg?b=1&s=170667a&w=0&k=20&c=0HC3hgBHaalf0-sbKXrR3HFd5kJTrXYOxIvLCZWwcYA="
                    alt=""
                  />
